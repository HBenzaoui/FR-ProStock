object LocaleListF: TLocaleListF
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    BevelOuter = bvNone
    Caption = 'La Liste Des Localisations'
    Color = 39167
    DoubleBuffered = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = 4207405
  ...
  object ResearchLocaleEdt: TSearchBox
    Left = 97
    Top = 97
    Width = 221
    Height = 26
    ...
    ParentFont = False
    TabOrder = 2
    OnChange = ResearchLocaleEdtChange
  end
  object CompteDBGridEh: TDBGridEh
    ...
    Columns = <
      item
        ...
        Title.Caption = 'Les Localisations'
  ...
  object LocaleListDataS: TDataSource
    DataSet = MainForm.LocalisationTable
    Left = 238
    Top = 360
  end
end
