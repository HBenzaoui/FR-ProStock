 ...
 begin
  key := #0;
   ...
   begin
        MainForm.SQLQuery.Active:=False;
        MainForm.SQLQuery.SQL.Clear;
        MainForm.SQLQuery.SQL.Text:= 'SELECT code_p,prixht_p,prixvd_p,prixvr_p,prixvg_p,prixva_p,prixva2_p,tva_p,perissable_p FROM produit WHERE LOWER(nom_p) LIKE LOWER('+QuotedStr(ProduitBonRecGCbx.Text)+')';
        MainForm.SQLQuery.Active:=True;
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  begin
            MainForm.SQLQuery.Active:=False;
            MainForm.SQLQuery.SQL.Clear;
            MainForm.SQLQuery.SQL.Text:= 'SELECT code_p,refer_p,prixht_p,prixvd_p,prixvr_p,prixvg_p,prixva_p,prixva2_p,tva_p,perissable_p FROM produit WHERE LOWER(refer_p) LIKE LOWER('+QuotedStr(ProduitBonRecGCbx.Text)+')';
            MainForm.SQLQuery.Active:=True;
            CodeP:= MainForm.SQLQuery.FieldByName('code_p').AsInteger ;
 ...
 //---------------------------------------------------------------------------------------------
  ...
  begin
   ...
   begin
    ...
    MainForm.SQLQuery.Active:=False;
    MainForm.SQLQuery.SQL.Clear;
    MainForm.SQLQuery.SQL.Text:= 'SELECT code_p,codebar_p,prixht_p,prixvd_p,prixvr_p,prixvg_p,prixva_p,prixva2_p,tva_p,perissable_p FROM produit WHERE code_p = '+QuotedStr(IntToStr(CodeCB)) +'OR'+ ' LOWER(codebar_p) LIKE LOWER(' + QuotedStr(ProduitBonRecGCbx.Text)+')';
    MainForm.SQLQuery.Active:=True;
    CodeP:= MainForm.SQLQuery.FieldByName('code_p').AsInteger ;
...
begin
  ...
  if (MainForm.Bona_recTable.FieldByName('code_mdpai').AsInteger<> 0) AND (MainForm.Bona_recTable.FieldByName('code_mdpai').AsInteger<>null)  then
  begin
  BonRecGestionF.ModePaieBonRecGCbx.Text:=MainForm.Bona_recTable.FieldByName('ModePaie').AsString;
  end;
  if (MainForm.Bona_recTable.FieldByName('code_cmpt').AsInteger<> 0) AND (MainForm.Bona_recTable.FieldByName('code_cmpt').AsInteger<>null)  then
  begin
  BonRecGestionF.CompteBonRecGCbx.Text:=MainForm.Bona_recTable.FieldByName('Compte').AsString;
  end;
  ...
  BonRecGestionF.DateBonRecGD.DateTime:= MainForm.Bona_recTable.FieldByName('date_barec').AsDateTime;
  BonRecGestionF.ObserBonRecGMem.Text:= MainForm.Bona_recTable.FieldByName('obser_barec').AsString;
...
begin
 ...
 if (FournisseurBonRecGCbx.Text <> '')
    and (MainForm.Bona_recTable.FieldByName('code_f').AsInteger <> 0)
