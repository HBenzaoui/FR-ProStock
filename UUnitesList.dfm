object UnitesListF: TUnitesListF
  Left = 0
  Top = 0
  ...
  object ResearchUniteEdt: TSearchBox
    Left = 50
    Top = 97
    Width = 267
    Height = 26
    ...
    ParentFont = False
    TabOrder = 2
    OnChange = ResearchUniteEdtChange
  end
  ...
  object UniteListDataS: TDataSource
    DataSet = MainForm.UniteTable
    Left = 278
    Top = 390
  end
end
