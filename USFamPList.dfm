object SFamPListF: TSFamPListF
  ...
  object ResearchSFamPEdt: TSearchBox
    Left = 65
    Top = 97
    Width = 251
    Height = 26
    ...
    ParentFont = False
    TabOrder = 2
    OnChange = ResearchSFamPEdtChange
  end
  object CompteDBGridEh: TDBGridEh
    ...
    Columns = <
      item
        ...
        Title.Caption = 'Les Sous Familles'
  ...
  object SFamPListDataS: TDataSource
    DataSet = MainForm.SfamproduitTable
    Left = 238
    Top = 360
  end
end
