  ...
  object FournisseurGPgControl: TsPageControl
    ...
    object GeneralClientGTB: TsTabSheet
      ...
      object GeneralTB: TPanel
        ...
        object CPostalFournisseurGLbl: TLabel
          Left = 257
          Top = 186
          Width = 75
          Height = 16
        ...
        object CountryFournisseurGLbl: TLabel
          Left = 257
          Top = 231
          Width = 41
          Height = 16
        ...
        object CPostalFournisseurGCbx: TComboBox
          Left = 275
          Top = 205
          Width = 210
          Height = 24
          ...
          ParentFont = False
          TabOrder = 13
          OnEnter = CPostalFournisseurGCbxEnter
        end
        object CountryFournisseurGCbx: TComboBox
          Left = 275
          Top = 250
          Width = 210
          Height = 24
          ...
          ParentFont = False
          TabOrder = 14
          OnEnter = CountryFournisseurGCbxEnter
        end
      end
    end
