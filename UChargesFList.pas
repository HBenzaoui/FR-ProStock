...
type
  TChargesFListF = class(TForm)
    ...
    procedure ChargesListDBGridEhDrawColumnCell(Sender: TObject;
...
procedure TChargesFListF.ChargesListDBGridEhDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumnEh;
  State: TGridDrawState);
begin
  HighlightCellText(TDBGridEh(Sender),Rect, Column,ResearchChargeEdt.Text,State);
end;
