...
uses
  ...
  Vcl.ExtCtrls, sStatusBar, Vcl.AppEvnts, frxExportBaseDialog;
...
type
  TPertesFListF = class(TForm)
    ...
    procedure PertesListDBGridEhDrawColumnCell(Sender: TObject;
...
procedure TPertesFListF.PertesListDBGridEhDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumnEh;
  State: TGridDrawState);
begin
  HighlightCellText(TDBGridEh(Sender),Rect, Column,ResearchPerteEdt.Text,State);
end;
