...
begin
  ...
  begin
   ...
   begin
    ...
    BonLivGOLDStock.Caption:=  floatTostrF((MainForm.ProduitTable.FieldValues['qut_p']),ffNumber,14,2);
    BonLivGNEWStock.Caption:=  floatTostrF(((MainForm.ProduitTable.FieldValues['qut_p'])-(MainForm.Bonv_liv_listTable.FieldValues['qut_p'])),ffNumber,14,2);
