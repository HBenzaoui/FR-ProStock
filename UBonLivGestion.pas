...
begin
      ...
      MainForm.SQLQuery4.SQL.Text := 'SELECT qut_p,code_p FROM bonv_liv_list WHERE code_bvliv = ' + QuotedStr(IntToStr(MainForm.Bonv_livTable.FieldByName('code_bvliv').AsInteger));
