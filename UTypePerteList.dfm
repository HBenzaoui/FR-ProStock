object TypePerteListF: TTypePerteListF
  Left = 0
  Top = 0
  ...
  object CompteDBGridEh: TDBGridEh
    ...
    DataSource = TypePertesListDataS
    DynProps = <>
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = 30
    ...
    Columns = <
      item
        ...
        Title.Caption = 'Les Types des Pertes'
  ...
  object TypePertesListDataS: TDataSource
    DataSet = DataModuleF.Perte_typeTable
    Left = 278
    Top = 390
  end
end
