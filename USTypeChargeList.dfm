object STypeChargeListF: TSTypeChargeListF
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    BevelOuter = bvNone
    Caption = 'Les Sous Types des Charges'
    Color = 12568683
    DoubleBuffered = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWhite
  ...
  object CompteDBGridEh: TDBGridEh
    ...
    DataSource = STypeChargeListDataS
    DynProps = <>
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = 30
    ...
    Columns = <
      item
        ...
        Title.Caption = 'Les Sous Types des Charges'
  ...
  object STypeChargeListDataS: TDataSource
    DataSet = DataModuleF.Charge_s_typeTable
    Left = 278
    Top = 390
  end
end
